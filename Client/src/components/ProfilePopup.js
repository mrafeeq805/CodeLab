		...
		<div className="absolute hidden transition-transform  p-2 bg-white border-2 right-16 top-14 rounded-md shadow-lg group-hover:block">
			...
			<div class="px-4 py-3 text-sm text-gray-900 flex gap-3">
				...
				<div className="flex flex-col">
					...
					<span className="text-gray-500">{cookie.get('email')}</span>
				</div>
			...
			<ul
				...
				<li className="group flex items-center hover:bg-light rounded-md pl-4">
					<i class="bi bi-box-seam group-hover:text-primary"></i>
					<Link
						to={'/myprojects'}
						class="block px-4 py-2 group-hover:text-primary">
						My Projects
					</Link>
				</li>
				<li className="group flex items-center hover:bg-light rounded-md pl-4">
					<i class="bi bi-person-fill-gear group-hover:text-primary"></i>
					<Link
						to={'/editprofile'}
						class="block px-4 py-2 group-hover:text-primary">
						Edit Profile
				...
				<li className="group flex items-center hover:bg-light rounded-md pl-4">
					<i class="bi bi-telephone group-hover:text-primary"></i>
					<Link
						href="#"
						class="block px-4 py-2 group-hover:text-primary">
						Contact Us
